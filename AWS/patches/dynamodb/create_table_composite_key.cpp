...
/**
   ...
   composite key, "Artist" (hash) and "SongTitle" (range).
...
int main(int argc, char** argv)
{
    ...
    Aws::InitAPI(options);
    {
        ...
        hashKey1.WithAttributeName("Artist").WithAttributeType(Aws::DynamoDB::Model::ScalarAttributeType::S);
        req.AddAttributeDefinitions(hashKey1);
        hashKey2.WithAttributeName("SongTitle").WithAttributeType(Aws::DynamoDB::Model::ScalarAttributeType::S);
        req.AddAttributeDefinitions(hashKey2);

        Aws::DynamoDB::Model::KeySchemaElement kse1, kse2;
        kse1.WithAttributeName("Artist").WithKeyType(Aws::DynamoDB::Model::KeyType::HASH);
        req.AddKeySchema(kse1);
        kse2.WithAttributeName("SongTitle").WithKeyType(Aws::DynamoDB::Model::KeyType::RANGE);
