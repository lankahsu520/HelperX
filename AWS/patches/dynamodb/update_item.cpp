...
int main(int argc, char** argv)
{
    ...
    Aws::InitAPI(options);
    {
        ...
        const Aws::String attributeNameAndValue = (argv[4]);
        ...
        attribValue.SetS(keyValue_pk);
        request.AddKey("Artist", attribValue);
        attribValue.SetS(keyValue_sk);
        request.AddKey("SongTitle", attribValue);
